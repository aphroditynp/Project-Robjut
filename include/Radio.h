...
// Ubah Serial8 menjadi Serial2 untuk ESP32
#define SBUS_RX_PIN 16 // Sesuaikan dengan pin RX yang digunakan
#define SBUS_TX_PIN 17 // Tidak selalu diperlukan untuk RX-only
